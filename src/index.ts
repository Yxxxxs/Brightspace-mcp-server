  ...
  async function main(): Promise<void> {
    try {
      ...
      const server = new McpServer({
        name: "brightspace",
        version: "1.1.2",
        description: "Brightspace MCP Server (github.com/Yxxxxs/Brightspace-mcp-server)",
      });
      log("INFO", "");
      log("INFO", "========================================");
      log("INFO", "  Brightspace MCP Server v1.1.2");
      log("INFO", "  By Yousef Alami");
      log("INFO", "  github.com/Yxxxxs/Brightspace-mcp-server");
      log("INFO", "========================================");
      log("INFO", "");
      ...
      log("INFO", "Brightspace MCP Server — running on stdio (12 tools registered)");
